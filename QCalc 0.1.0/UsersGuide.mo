...
package UsersGuide "User's Guide"
  ...
  package Publications "Publications"
    ...
    <p>The publications listed below describe the development of <a href=\"modelica://QCalc\">QCalc</a>.</p>
  ...
  package References "References"
    ...
    annotation (preferredView="info", Documentation(info="<html>
    <p>The references listed below are cited throughout <a href=\"modelica://QCalc\">QCalc</a>.</p>
    </html>"));
  end References;
...
<p>
<a href=\"modelica://QCalc\">QCalc</a> is maintained with three main branches on GitHub at 
<a href=\"https://github.com/kdavies4/QCalc\">https://github.com/kdavies4/QCalc</a>:
</p>
...
<p>
After version 1.0.0, the changes in each release of <a href=\"modelica://QCalc\">QCalc</a> will be
...
<a href=\"http://git-scm.com/\">git version control system</a>.
  ...
  class Contact "Contact"
    ...
    <a href=\"https://github.com/kdavies4/QCalc/issues/new\">open an issue</a>.
    If possible, please share any fixes and improvements as pull requests to the 
    master branch of the <a href=\"https://github.com/kdavies4/QCalc\">GitHub repository</a>.</p>
...
<p><b>Acknowledgments:</b></p><ul>
  ...
  class License "License"
    extends Icons.Information;
    annotation (preferredView="info", Documentation(info="<html>
<p>All files in this directory (QCalc) and all subdirectories are licensed by
