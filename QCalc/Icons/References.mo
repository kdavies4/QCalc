...
partial class References "Icon for external references (from MSL 3.2.1)"
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
            {100,100}}), graphics={
        Polygon(
          points={{-100,-80},{-100,60},{-80,54},{-80,80},{-40,58},{-40,100},{-10,
              60},{90,60},{100,40},{100,-100},{-20,-100},{-100,-80}},
          lineColor={0,0,255},
        ...
        Line(points={{-10,60},{-40,100},{-40,-40},{-10,-80},{-10,60}}, color={0,
              0,0}),
        ...
        Line(points={{10,-50},{70,-50}}, color={0,0,0})}), Documentation(info="<html>
